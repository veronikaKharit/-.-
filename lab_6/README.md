...
Такой подход является логичным продолжением предыдущей работы. Если в лабораторной работе №5 основной акцент делался на архитектуре, взаимодействии контейнеров и запуске приложения, то в лабораторной работе №6 внимание переносится на внутреннюю организацию кода. Цель состоит в том, чтобы показать, какие шаблоны проектирования уже используются в проекте, как они соотносятся с решаемыми задачами и какие преимущества дают при разработке и сопровождении системы.
